...
Draggable = (function () {
  ...
  Draggable.prototype.began = function (event) {
    ...
    this.origin.pageX = this.coordinate(event).pageX;
    this.origin.pageY = this.coordinate(event).pageY;
  ...
  Draggable.prototype.ended = function (event) {
    ...
    if(this.origin.pageX==this.coordinate(event).pageX&&this.origin.pageY==this.coordinate(event).pageY){
      //只是点击没有拖拽
      delete this.$target;
      delete this.origin;
      return false;
