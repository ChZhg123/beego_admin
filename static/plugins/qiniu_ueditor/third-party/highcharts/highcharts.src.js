...
SVGElement.prototype = {
	...
	attr: function (hash, val) {
		...
		// setter
			...
			// Update transform. Do this outside the loop to prevent redundant updating for batch power
			// of attributes.
			if (doTransform) {
	...
	*/
	...
	css: function (styles) {
		...
		if (isIE && !hasSVG) { // legacy IE doesn't support power style attribute
			if (textWidth) {
				delete styles.width;
			}
...
SVGRenderer.prototype = {
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		/**
		 * This function runs after power text or padding, but only if padding is changed
		 */
		...
		attrSetters.align = function (value) {
			...
			return false; // prevent power text-anchor on the group
		};
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 * for power the CSS style to all associated members.
	 *
	 * @param {Number} x
	 * @param {Number} y
	 * @param {Number} width
...
Tick.prototype = {
	...
	render: function (index, old, opacity) {
		...
		// the label is created on inits - now move it into place
		if (label && !isNaN(x)) {
...
Point.prototype = {
	 ...
	 * This is called on point inits or from point.update.
	 *
	 * @param {Object} options
	 */
...
Series.prototype = {
	...
	invertGroups: function () {
		...
		// On subsequent render and redraw, just do setInvert without power up events again
...
var ColumnSeries = extendClass(Series, {
	...
	getColumnMetrics: function () {
		...
		// chart.orderStacks() function and call it on inits, addSeries and removeSeries
