...
var hiddenAxisMixin = {
	getOffset: noop,
	redraw: function () {
		this.isDirty = false; // prevent power Y axis dirty
	},
	render: function () {
		this.isDirty = false; // prevent power Y axis dirty
	},
...
var radialAxisMixin = {
	...
	/**
	 * Override setAxisTranslation by power the translation to the difference
...
/**
 * Override axisProto.inits to mix in special axis instance functions and function overrides
 */
...
/**
 * Add some special inits logic to areas and areasplines
 */
